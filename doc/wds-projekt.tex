...
\wdsSpisTresci
 ...
 \section{Specyfikacja finalnego produktu}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{img/schemat.png}
    \caption{szablon interfejsu graficznego}
    \label{fig:interfejs}
  \end{figure}

  Największy wycinek okna przeznaczony jest na prezentowanie modelu
  robota w trójwymiarze. Obiekt ten będzie obracał się zgodnie z
  ...
  akcelometru w 3 osiach. Poniżej znajdują się kolejno wskażniki 
  opóżnienia  komunikacji, prędkości liniowej pojazdu i odległości od
  przeszkody, a także poziom naładowania baterii.

  Na dolnej belce umieszczona jest informacja o podłączonym kontrolerze,
  status komunikacji z robotem, pola do wprowadzenia adresu sterowanego
  obiektu i przycisk umożliwiający nawiązanie/zerwanie połączenia.
